<?php
$curl=new Tool_Curl();
$url="http://copmpany-suzhi.tp.com/api.php/v1/"."/city/open_city";
$method="get";
$data=array("id"=>1);
$header=array("TOKEN"=>'AClQJQBzVXAFMg53BVpVNFJpVnwKYAo3UGdQNgAkCihVcwg2AWoLOAd3WmsOPwQ5AG9SaVU2AThWZV4wAj4AMAAv');
$result=$curl->expire(10)->head(false)->$method($url,$data,$header);
echo '<pre>';
