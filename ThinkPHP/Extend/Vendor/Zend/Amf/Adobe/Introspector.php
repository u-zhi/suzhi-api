...
/**
 * This class implements a services for generating AMF services descriptions as XML.
 *
 * @package    Zend_Amf
 * @subpackage Adobe
 * @copyright  Copyright (c) 2005-2009 Zend Technologies USA Inc. (http://www.zend.com)
...
class Zend_Amf_Adobe_Introspector 
{
    ...
    /**
     * Create XML definition on an AMF services class
     * 
     * @param  string $serviceClass Service class name
     * @param  array $options invocation options
     * @return string XML with services class introspection
     */
    public function introspect($serviceClass, $options = array()) 
    {
        ...
        if (strpbrk($serviceClass, '\\/<>')) {
            return $this->_returnError('Invalid services name');
        }
        ...
        $serv = $this->_xml->createElement('services-description');
        $serv->setAttribute('xmlns', 'http://ns.adobe.com/flex/services-description/2008');
    ...
    /**
     * Build XML services description from reflection class
     * 
    ...
    /**
     * Get the array of services directories
     * 
